...
from .trust_statement import canonical_bytes, sign_ed25519

ATTESTATION_KEY_ID = "light-attest-1"


def stamp_apk(*, apk: Path, build_recipe_path: Path, registry_path: Path, dev_id: str,
    ...
    signature = sign_ed25519(canonical_bytes(trust_statement), attestation_key)
